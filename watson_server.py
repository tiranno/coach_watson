...
class NutritionHandler(BaseHandler):
    ...
    def post(self):
        protein = self.get_argument('protein_amount','')
        fiber = self.get_argument('fiber_amount','')
        calories = self.get_argument('calories_amount','')
        fat = self.get_argument('fat_amount','')
        cholesterol = self.get_argument('cholesterol_amount','')
        sodium = self.get_argument('sodium_amount','')
        sugar = self.get_argument('sugar_amount','')
...
class NutritionResultsHandler(BaseHandler):
    @tornado.web.authenticated
    def get(self):
        title = "Nutrition Results"
...
class AdminHandler(BaseHandler):
    ...
    def get(self):
        title = "Admin Page"
        self.render('app.html', content='partials/_admin.html', title=title)

    def post(self):
        foodname = self.get_argument('food_name','')
        ...
        self.application.db['foods'].insert_one(fooditem)
