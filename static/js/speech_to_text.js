...
var S2Tws = new WebSocket("wss://stream.watsonplatform.net/speech-to-text/api/v1/recognize?watson-token=" + token + "&model=es-ES_BroadbandModel");
S2Tws.onopen = function() {
    var start_message = "{\"action\": \"start\", \"content-type\": \"audio/l16;rate=22050\"}";
